...
//  public static final String REGION_CN_HANGZHOU = "cn-shenzhen";
  ...
  public static void main(String[] args) {
    ...
    String accessKeyId = "wtu1pInjqAE4FKKh";
    String accessKeySecret = "zL5ei2ddcmiMjBmYygITVBQEwpMGXM";

    // AssumeRole API 请求参数: RoleArn, RoleSessionName, Polciy, and DurationSeconds

    // RoleArn 需要在 RAM 控制台上获取
    String roleArn = "acs:ram::1577875926533685:role/aliyunosstokengeneratorrole";
